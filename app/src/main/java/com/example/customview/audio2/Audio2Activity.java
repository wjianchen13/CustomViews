...
public class Audio2Activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_audio2_main);
        ...
        mRecycler.setAdapter(new RecyclerView.Adapter<IndicatorHolder>() {
            ...
            public IndicatorHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                View itemView = getLayoutInflater().inflate(R.layout.item_audio2_indicator,parent,false);
            ...
            public void onBindViewHolder(IndicatorHolder holder, final int position) {
                ...
                holder.itemLayout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent=new Intent(Audio2Activity.this,IndicatorActivity.class);
